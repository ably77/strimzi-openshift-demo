...
sed -e "s/<PRODUCERNAME>/kafka-producer1/g" -e "s/<NAMESPACE>/$namespace/g" -e "s/<PARALLELISM>/${job1_parallelism}/g" -e "s/<COMPLETIONS>/${job1_completions}/g" -e "s/<KAFKATOPIC>/my-topic1/g" -e "s/<RECORDSIZE>/5/g" -e "s/<NODEIP>/${nodeip}/g" -e "s/<NODEPORTBS>/${nodeportbs}/g" -e "s/<NODEPORT0>/${nodeport0}/g" -e "s/<NODEPORT1>/${nodeport1}/g" -e "s/<NODEPORT2>/${nodeport2}/g" jobs/templates/job.template.yaml > jobs/generated/job1.yaml
sed -e "s/<PRODUCERNAME>/kafka-producer2/g" -e "s/<NAMESPACE>/$namespace/g" -e "s/<PARALLELISM>/${job2_parallelism}/g" -e "s/<COMPLETIONS>/${job2_completions}/g" -e "s/<KAFKATOPIC>/my-topic2/g" -e "s/<RECORDSIZE>/5/g" -e "s/<NODEIP>/${nodeip}/g" -e "s/<NODEPORTBS>/${nodeportbs}/g" -e "s/<NODEPORT0>/${nodeport0}/g" -e "s/<NODEPORT1>/${nodeport1}/g" -e "s/<NODEPORT2>/${nodeport2}/g" jobs/templates/job.template.yaml > jobs/generated/job2.yaml
sed -e "s/<PRODUCERNAME>/kafka-producer3/g" -e "s/<NAMESPACE>/$namespace/g" -e "s/<PARALLELISM>/${job3_parallelism}/g" -e "s/<COMPLETIONS>/${job3_completions}/g" -e "s/<KAFKATOPIC>/my-topic1/g" -e "s/<RECORDSIZE>/10/g" -e "s/<NODEIP>/${nodeip}/g" -e "s/<NODEPORTBS>/${nodeportbs}/g" -e "s/<NODEPORT0>/${nodeport0}/g" -e "s/<NODEPORT1>/${nodeport1}/g" -e "s/<NODEPORT2>/${nodeport2}/g" jobs/templates/job.template.yaml > jobs/generated/job3.yaml
